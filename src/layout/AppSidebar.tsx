    ...
    items: [
      {
        ...
        subItems: [
          { name: "Laporan Kehadiran", path: "/laporan/kehadiran" },
          { name: "Laporan Patroli", path: "/laporan/patroli" },
          { name: "Laporan Insiden", path: "/laporan/insiden" },
        ],
      },
    ]
  }
...
const AppSidebar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    ["main", "others"].forEach((menuType) => {
      const items = menuType === "main" ? navGroups.flatMap(g => g.items) : othersItems;
      items.forEach((nav) => {
        if (nav.subItems) {
  ...
  const handleSubmenuToggle = (index: string, menuType: "main" | "others") => {
          ...
          {nav.subItems ? (
            <button
              ...
              className={`menu-item group ${
                openSubmenu?.type === menuType && openSubmenu?.index === nav.name
                  ? "menu-item-active"
                  : "menu-item-inactive"
              } cursor-pointer ${
